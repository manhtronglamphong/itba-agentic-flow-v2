...
source: BABOK v3 §10.35
status: SKELETON
category: RADD / Modelling
used_by_KAs: [KA2,KA4,KA5]
used_by_tasks: [4.1,4.2,5.1]
---

# T35 — Process Modelling

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.35 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.35.
