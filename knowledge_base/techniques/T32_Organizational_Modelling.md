...
source: BABOK v3 §10.32
status: SKELETON
category: Strategy / Structure
used_by_KAs: [KA1,KA4,KA6]
used_by_tasks: [4.1,4.2,6.4]
---

# T32 — Organizational Modelling

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.32 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.32.
