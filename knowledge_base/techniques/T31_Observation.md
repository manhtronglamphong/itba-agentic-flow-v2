...
id: T31
name: Observation
source: BABOK v3 §10.31
status: SKELETON
category: Elicitation / Field
...
## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.31 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.31.
