...
id: T29
name: Mind Mapping
source: BABOK v3 §10.29
status: SKELETON
category: Elicitation / Visualization
used_by_KAs: [KA2,KA4]
...
## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.29 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.29.
