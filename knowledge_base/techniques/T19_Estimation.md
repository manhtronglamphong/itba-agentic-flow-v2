...
id: T19
name: Estimation
source: BABOK v3 §10.19
status: SKELETON
category: Planning / Sizing
used_by_KAs: [KA1,KA3,KA4]
used_by_tasks: [3.4,4.4]
---

# T19 — Estimation

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.19 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.19.
