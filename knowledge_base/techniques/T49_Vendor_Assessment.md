...
source: BABOK v3 §10.49
status: SKELETON
category: Strategy / External
used_by_KAs: [KA4,KA6]
used_by_tasks: [4.1,4.2,4.4,6.5]
---

# T49 — Vendor Assessment

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.49 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.49.
