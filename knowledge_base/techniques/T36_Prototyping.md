...
id: T36
name: Prototyping
source: BABOK v3 §10.36
status: SKELETON
category: Elicitation / Design
used_by_KAs: [KA2,KA5,KA6]
used_by_tasks: [5.1]
---
...
## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.36 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.36.
