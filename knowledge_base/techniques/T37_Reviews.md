...
id: T37
name: Reviews
source: BABOK v3 §10.37
status: SKELETON
category: Verification
used_by_KAs: [KA1,KA3,KA5]
used_by_tasks: [5.2]
---
...
## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.37 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.37.
