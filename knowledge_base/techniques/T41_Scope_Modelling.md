...
source: BABOK v3 §10.41
status: SKELETON
category: RADD / Specification
used_by_KAs: [KA4,KA5]
used_by_tasks: [4.1,4.2,4.4,5.4]
---

# T41 — Scope Modelling

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.41 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.41.
...
- **Knowledge Areas:** KA4,KA5
- **Tasks:** 4.1,4.2,4.4,5.4
