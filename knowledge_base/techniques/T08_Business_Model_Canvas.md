...
source: BABOK v3 §10.08
status: SKELETON
category: Strategy / Model
used_by_KAs: [KA4]
used_by_tasks: [4.1,4.2,4.4]
---

# T08 — Business Model Canvas

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.08 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.08.
