...
source: BABOK v3 §10.09
status: SKELETON
category: RADD / Specification
used_by_KAs: [KA2,KA3,KA5]
used_by_tasks: [5.1,5.4]
---

# T09 — Business Rules Analysis

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.09 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.09.
