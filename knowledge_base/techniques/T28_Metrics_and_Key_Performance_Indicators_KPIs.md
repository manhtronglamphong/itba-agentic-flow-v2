...
source: BABOK v3 §10.28
status: SKELETON
category: Measurement
used_by_KAs: [KA1,KA4,KA6]
used_by_tasks: [4.1,4.2,6.1]
---

# T28 — Metrics and Key Performance Indicators (KPIs)

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.28 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.28.
