...
source: BABOK v3 §10.40
status: SKELETON
category: Analysis / Diagnostic
used_by_KAs: [KA4,KA6]
used_by_tasks: [4.1,4.3]
---

# T40 — Root Cause Analysis

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.40 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.40.
