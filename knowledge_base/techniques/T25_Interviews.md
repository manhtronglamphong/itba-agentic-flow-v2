...
id: T25
name: Interviews
source: BABOK v3 §10.25
status: SKELETON
category: Elicitation / Direct
used_by_KAs: [KA1,KA2,KA4,KA6]
used_by_tasks: [2.2,4.1,4.2,4.3]
---

# T25 — Interviews

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.25 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.25.
