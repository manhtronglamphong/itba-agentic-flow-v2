...
source: BABOK v3 §10.10
status: SKELETON
category: Elicitation / Workshop technique
used_by_KAs: [KA2]
used_by_tasks: [2.2]
---

# T10 — Collaborative Games

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.10 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.10.
