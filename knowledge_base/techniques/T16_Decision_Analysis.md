...
source: BABOK v3 §10.16
status: SKELETON
category: Strategy / Decision support
used_by_KAs: [KA3,KA4,KA5,KA6]
used_by_tasks: [4.2,4.3,4.4,5.6,6.5]
---

# T16 — Decision Analysis

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.16 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.16.
...
- **Knowledge Areas:** KA3,KA4,KA5,KA6
- **Tasks:** 4.2,4.3,4.4,5.6,6.5
