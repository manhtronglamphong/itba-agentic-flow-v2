...
source: BABOK v3 §10.22
status: SKELETON
category: Analysis / Structure
used_by_KAs: [KA1,KA4,KA5]
used_by_tasks: [4.1,4.2,5.1,5.4]
---

# T22 — Functional Decomposition

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.22 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.22.
