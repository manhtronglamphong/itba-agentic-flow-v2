...
source: BABOK v3 §10.06
status: SKELETON
category: Strategy / Current-state
used_by_KAs: [KA4]
used_by_tasks: [4.1,4.4]
---

# T06 — Business Capability Analysis

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.06 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.06.
