...
source: BABOK v3 §10.18
status: SKELETON
category: Elicitation / Research
used_by_KAs: [KA2,KA4]
used_by_tasks: [4.1,4.3]
---

# T18 — Document Analysis

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.18 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.18.
