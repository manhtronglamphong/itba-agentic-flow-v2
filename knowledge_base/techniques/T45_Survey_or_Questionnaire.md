...
source: BABOK v3 §10.45
status: SKELETON
category: Elicitation / Broad sampling
used_by_KAs: [KA1,KA2,KA4,KA6]
used_by_tasks: [4.1,4.2,4.3]
---

# T45 — Survey or Questionnaire

## Purpose
*(To be populated.)* Concise one-sentence statement of why a BA would reach for this technique. Refer to BABOK v3 §10.45 for the canonical wording.
...
## Elements
*(To be populated.)* List the named sub-components per BABOK v3 §10.45.
...
- **Knowledge Areas:** KA1,KA2,KA4,KA6
- **Tasks:** 4.1,4.2,4.3
